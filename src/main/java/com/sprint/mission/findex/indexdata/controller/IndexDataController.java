...
public class IndexDataController {
  ...
  Post/ /api/index-data
   */
  @Operation(summary = "지수 데이터 등록", operationId = "IndexData_1", description = "새로운 지수 데이터를 등록합니다.")
  @ApiResponses({
   ...
   */
  @Operation(summary = "지수 데이터 수정", operationId = "IndexData_2", description = "기존 지수 데이터를 수정합니다.")
  @ApiResponses({
   ...
   */
  @Operation(summary = "지수 데이터 삭제", operationId = "IndexData_3", description = "지수 데이터를 삭제합니다.")
  @ApiResponses({
  ...
  Get/ /api/index-data
   */
  @Operation(summary = "지수 데이터 목록 조회", operationId = "IndexData_4", description = "지수 데이터 목록을 조회합니다. 필터링, 정렬, 커서 기반 페이지네이션을 지원합니다.")
  @ApiResponses({
   ...
   */
  @Operation(summary = "지수 데이터 CSV export", operationId = "IndexData_5", description = "지수 데이터를 CSV 파일로 export합니다.")
  @ApiResponses({
  ...
  // 대시보드
     ...
     */
  @Operation(summary = "지수 차트 조회", operationId = "IndexData_6", description = "지수의 차트 데이터를 조회합니다.")
  @ApiResponses({
  ...
  public ResponseEntity<IndexChartDto> getIndexChart(
     ...
     */
  @Operation(summary = "지수 성과 랭킹 조회", operationId = "IndexData_7", description = "지수의 성과 분석 랭킹을 조회합니다.")
  @ApiResponses({
   ...
   */
  @Operation(summary = "관심 지수 성과 조회", operationId = "IndexData_8", description = "즐겨찾기로 등록된 지수들의 성과를 조회합니다.")
  @ApiResponses({
